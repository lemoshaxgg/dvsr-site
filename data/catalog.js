export const categories = [
  ...
  { id: 'pipe',      label: 'Трубопроводная арматура',   img: '/catalog/products/100.jpg' },
  { id: 'industry',  label: 'Промышленное оборудование', img: '/catalog/products/40.jpg' },
  { id: 'rti',       label: 'РТИ и комплектующие',       img: '/catalog/products/97.jpg' },
  { id: 'hardware',  label: 'Метизы',                    img: '/catalog/products/85.jpg' },
  ...
  { id: 'cable',     label: 'Кабели и провода',          img: '/catalog/products/216.jpg' },
  { id: 'stainless', label: 'Нержавеющий прокат',        img: '/catalog/products/114.jpg' },
  { id: 'metalroll', label: 'Металлопрокат',             img: '/catalog/products/119.jpg' },
  { id: 'hatches',   label: 'Люки и шахты',              img: '/catalog/products/250.jpg' },
